...
describe("ThinkingTagExtractor", () => {
  describe("basic functionality", () => {
    it("should extract thinking content with simple tags", () => {
      ...
      const result = extractor.process("<think>thinking content</think>regular content");
    ...
    it("should handle multiple thinking blocks", () => {
      const extractor = new ThinkingTagExtractor("<think>", "</think>");
      const result = extractor.process("<think>first</think>middle<think>second</think>end");
  ...
  describe("custom tag formats", () => {
    it("should work with vLLM default reasoning tags", () => {
      ...
      const result = extractor.process("<reasoning>my reasoning</reasoning>answer");
    ...
    it("should work with simple brackets", () => {
      const extractor = new ThinkingTagExtractor("[THINK]", "[/THINK]");
      const result = extractor.process("[THINK]internal thoughts[/THINK]response");
      expect(result.thinking).toBe("internal thoughts");
      expect(result.content).toBe("response");
    });

    it("should work with multi-character tags", () => {
      const extractor = new ThinkingTagExtractor("<<<REASONING>>>", "<<<END_REASONING>>>");
      const result = extractor.process("<<<REASONING>>>deep thoughts<<<END_REASONING>>>output");
  ...
  describe("edge cases", () => {
    ...
    it("should handle nested-like content (not actual nesting)", () => {
      ...
      const result = extractor.process("<think>outer <think> inner</think> after</think>");
    ...
    it("should handle special characters in tags", () => {
      const extractor = new ThinkingTagExtractor("<!--THINK-->", "<!--/THINK-->");
      const result = extractor.process("<!--THINK-->special<!--/THINK-->normal");
